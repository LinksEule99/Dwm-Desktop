...
/* Gruvbox-inspired (White text, Yellow focus) */

static const char *colorname[] = {
    /* 8 normal colors */
    [0] = "#282828", /* black (background tone) */
    [1] = "#cc241d", /* red */
    [2] = "#98971a", /* green */
    [3] = "#d79921", /* yellow */
    [4] = "#458588", /* blue */
    [5] = "#b16286", /* magenta */
    [6] = "#689d6a", /* cyan */
    [7] = "#ebdbb2", /* white (light text) */

    /* 8 bright colors */
    [8]  = "#928374", /* bright black */
    [9]  = "#fb4934", /* bright red */
    [10] = "#b8bb26", /* bright green */
    [11] = "#fabd2f", /* bright yellow — more punchy */
    [12] = "#83a598", /* bright blue */
    [13] = "#d3869b", /* bright magenta */
    [14] = "#8ec07c", /* bright cyan */
    [15] = "#ffffff", /* bright white — for emphasis */

    /* Special colors */
    [256] = "#282828", /* background */
    [257] = "#ffffff", /* foreground (default white text) */
    [258] = "#d79921", /* cursor color (warm yellow) */
};

/* Default colors */
unsigned int defaultfg = 257; /* white text */
unsigned int defaultbg = 256; /* dark background */
unsigned int defaultcs = 258; /* yellow cursor */
unsigned int defaultrcs = 258; /* reverse cursor */
